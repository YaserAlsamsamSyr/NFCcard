...
return [
    ...
    */
    ...
    'confirmed' => ':attribut هذا الحقل لم يحدث معه عملية مطابقة من أجل تأكيد',
    ...
    */
    ...
    'custom' => [
        ...
        'araName'=>[
            'required'=>"يجب أدخال الأسم بللغة العربية",
            'string'=>"يجب ان يكون لأسم مؤلف من محارف فقط",
            'max:255'=>"يجب ان يكون لأسم في للغة العربية مؤلف على لأكثر من 255 حرف"
        ],
        'engName'=>[
            'required'=>"يجب أدخال الأسم بللغة الانكليزية",
            'string'=>"يجب ان يكون لأسم مؤلف من محارف فقط",
            'max:255'=>"يجب ان يكون لأسم في للغة الانكليزية مؤلف على لأكثر من 255 حرف"
        ],
        'firstName'=>[
        ...
        'address'=>[
            ...
            'max:255'=>"يجب ان يكون العنوان مؤلف على لأكثر من 255 حرف"
        ],
        'img'=>[
        ...
        'age'=>[
            'numeric'=>'العمر يجب أن يكون رقم',
            'min'=>'العمر يجب أن يأخذ على الأقل القيمة 1 ',
            'max'=>'العمر يجب أن يأخذ على الأكثر القيمة 150'
        ],
        'phone'=>[
    ...
    */
    ...
    'attributes' => [
        'email'=>'الايميل',
        'araName'=>'الأسم في العربي',
        'engName'=>'الأسم في الانكليزي',
        'firstName'=>'الأسم',
        'lastName'=>'الكنية',
        'address'=>'العنوان',
        'img'=>'الصورة',
